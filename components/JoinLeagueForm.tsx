  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
      <input
        ...
        maxLength={6}
        className="flex-1 bg-gray-900 border border-purple-500/30 rounded-xl px-6 py-4 text-white uppercase font-mono placeholder:text-gray-500 focus:outline-none focus:border-purple-500 transition-colors"
      />
      <button
        type="submit"
        disabled={loading}
